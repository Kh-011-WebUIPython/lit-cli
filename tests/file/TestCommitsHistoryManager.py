...
class TestCommitsHistoryManager(unittest.TestCase):
    ...
    def test_write_commit_success(self):
        CommitsHistoryManager.write_commit_info(self.commit_message_text_1, self.commit_hash_1)
    ...
    def test_read_all_commits(self):
        CommitsHistoryManager.write_commit_info(self.commit_message_text_1, self.commit_hash_1)
        CommitsHistoryManager.write_commit_info(self.commit_message_text_2, self.commit_hash_2)
